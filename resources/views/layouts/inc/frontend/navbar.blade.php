        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <img src="https://media.discordapp.net/attachments/1098990936786227292/1113843219797643385/LogoMakr-5DKJEy.png" alt="Logo">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="nav-link" href="{{ url('/collections') }}">All Categories</a></li>
                        <li><a class="nav-link" href="{{ url('/new-arrivals') }}">New Arrivals</a></li>
                        <li><a class="nav-link" href="{{ url('/featured-products') }}">Featured Products</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
